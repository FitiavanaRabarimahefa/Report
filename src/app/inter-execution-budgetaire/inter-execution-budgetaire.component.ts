...
@Component({
  selector: 'app-inter-execution-budgetaire',
  templateUrl: './inter-execution-budgetaire.component.html',
  styleUrls: ['./inter-execution-budgetaire.component.css']
})
export class InterExecutionBudgetaireComponent implements OnInit {
