...
@Component({
  selector: 'app-inter-centre-informatique',
  templateUrl: './inter-centre-informatique.component.html',
  styleUrls: ['./inter-centre-informatique.component.css']
})
export class InterCentreInformatiqueComponent implements OnInit {
