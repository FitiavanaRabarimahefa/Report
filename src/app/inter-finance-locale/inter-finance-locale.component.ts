...
@Component({
  selector: 'app-inter-finance-locale',
  templateUrl: './inter-finance-locale.component.html',
  styleUrls: ['./inter-finance-locale.component.css']
})
export class InterFinanceLocaleComponent implements OnInit {
